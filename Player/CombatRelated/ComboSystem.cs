...
public class ComboSystem : MonoBehaviour
{
    ...
    public void SetCurrentAttackNode(AttackNode attackNode)
    {
    ...
    public bool CanRestartCombo()
    {
        return CurrentAttackNode.noNextAttack && 
               animationHandler.IsPlaying(CurrentAttackNode.attackName) &&
               animationHandler.NormalizedTime() >= CurrentAttackNode.timeToLetRestartCombo;
    }
