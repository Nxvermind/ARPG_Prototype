...
public class PlayerStateFactory 
{
    ...
    public PlayerPerfectDodgeAttackState PerfectDodgeAttackState { get; private set; }
    ...
    [Header("Skills")]
    public PlayerDashSkillState DashSkillState { get; private set; }
    ...
    public void InitializeState(Player player, StateMachine<Player> stateMachine)
    {
        ...
        DashSkillState = new PlayerDashSkillState(player, stateMachine);
        ...
        PerfectDodgeAttackState = new PlayerPerfectDodgeAttackState(player, stateMachine);
    }
}
