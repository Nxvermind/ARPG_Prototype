...
public class EliteEnemyStateFactory : EnemyStateFactory
{
    ...
    public EliteEnemyRepositioningState RepositioningState { get; private set; }

    public EliteEnemyAssaultSkillState AssaultSkillState { get; private set; }

    public EliteEnemyGetReadyToAssaultSkillState GetReadyToAssaultSkillState { get; private set; }
    ...
    public override void InitializeState(Enemy enemy, EnemyStateFactory enemyStateFactory, StateMachine<Enemy> stateMachine)
    {
        ...
        RepositioningState = new EliteEnemyRepositioningState(eliteEnemy, this, stateMachine);
        AssaultSkillState = new EliteEnemyAssaultSkillState(eliteEnemy, this, stateMachine);
        GetReadyToAssaultSkillState = new EliteEnemyGetReadyToAssaultSkillState(eliteEnemy, this, stateMachine);
    }
}
